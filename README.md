...
### 課題4 「自由課題」
先程までの「for文」や「if文」を使って自由に何かプログラムを作って見ましょう。  
大概のプログラムは、「for文」、「if文」の他にここでは説明していない「while文」がありますが、この２種類の制御文で書くことが可能です。  
<br>
## 4, まとめ  
今回のプログラム講習で難しいと感じたかもしれませんが、毎日の業務の中で、「毎日」・「毎週」・「毎月」行うような仕事は、プログラムに置き換えることによりメリットが出るかもしれません。  
どうしても、人が行うような作業にはミスがつきものです。しかしコンピュータは、何千回何万回と行う作業も嫌と言わず間違いなく仕事をこなしてくれます。  
今後、もっとプログラミングの敷居が下がれば、人の行う作業は、発想や創造するだけで取って代わるかもしれません。  
逆に言えば、発想や創造次第でいくらでも仕事が楽になります。  
是非、各部署に配属された際には、新しい技術を積極的に見聞きし、どのようにすれば効率的に仕事が回るかを考え続けて見てください。  
